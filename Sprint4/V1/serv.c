...
int main (int argc, char** argv) {
  ...
  strcpy(tabSalon[0].nom, "chasse");
  tabSalon[0].numSalon = 1;
  tabSalon[0].nbMaxCli = 2;

  strcpy(tabSalon[1].nom, "peche");
  tabSalon[1].numSalon = 2;
  tabSalon[1].nbMaxCli = 2;

  strcpy(tabSalon[2].nom, "politique");
  tabSalon[2].numSalon = 3;
  tabSalon[2].nbMaxCli = 2;

  strcpy(tabSalon[3].nom, "banane");
  tabSalon[3].numSalon = 4;
  tabSalon[3].nbMaxCli = 2;

  strcpy(tabSalon[4].nom, "poisson");
  tabSalon[4].numSalon = 5;
  tabSalon[4].nbMaxCli = 2;
